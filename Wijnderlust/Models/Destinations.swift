...
enum Destinations: String {
    ...
    static var allDestinations = [amsterdam.data, barcelona.data, rome.data, florence.data, berlin.data, paris.data, london.data, vienna.data, brussels.data, dublin.data, lisbon.data, milan.data, prague.data]
}
